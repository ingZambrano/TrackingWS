...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"blast",prev:"",next:"",duration:20*100,delay:36*100,outWidth:500,outHeight:374,width:500,height:374,autoPlay:true,stopOnHover:false,loop:false,bullets:0,caption:false,controls:false});